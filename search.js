...
const allProducts = {
    ...
    'cumin-seeds': {
        id: 'cumin-seeds',
        title: 'Cumin Seeds (Zeera)',
        category: 'spices',
        keywords: ['cumin', 'zeera', 'seeds', 'spice']
    },
    'coriander-seeds': {
        id: 'coriander-seeds',
        title: 'Coriander Seeds (Dhania)',
        category: 'spices',
        keywords: ['coriander', 'dhania', 'seeds', 'spice']
    },
    'garam-masala': {
        id: 'garam-masala',
    ...
    'urad-dal': {
        ...
        category: 'pulses',
        keywords: ['urad dal', 'black', 'lentils', 'pulse']
    },
    'whole-chickpeas': {
        id: 'whole-chickpeas',
        title: 'Whole Chickpeas (Kabuli Chana)',
        category: 'pulses',
        keywords: ['chickpeas', 'kabuli chana', 'whole', 'pulse']
    },
    'mustard-oil': {
        id: 'mustard-oil',
    ...
    'sesame-oil': {
        id: 'sesame-oil',
        title: 'Pure Sesame Oil (Til Oil)',
        category: 'oils',
        keywords: ['sesame oil', 'til', 'pure', 'cooking oil']
    },
    'whole-wheat-flour': {
    ...
    'roasted-pistachios': {
        ...
        title: 'Roasted Pistachios (Pista)',
        category: 'nuts',
        keywords: ['pistachios', 'pista', 'roasted', 'nuts']
    },
    'premium-cashews': {
        id: 'premium-cashews',
    ...
    'assam-black-tea': {
        ...
        category: 'tea',
        keywords: ['assam', 'black tea', 'tea', 'beverage']
    },
    'organic-green-tea': {
        id: 'organic-green-tea',
        title: 'Organic Green Tea',
        category: 'tea',
        keywords: ['green tea', 'organic', 'tea', 'health']
    },
